...
sudo ip net exec H1_1 ip addr add 137.204.4.2/24 dev veth4_1

sudo ip net exec H1_1 ip r add 137.204.4.0/24 via 137.204.4.2 dev veth4_1
sudo ip net exec H4_1 ip r add default via 137.204.4.2
